      ...
      <div className="container py-5 text-center text-black md:text-left lg:py-9">
        <div className="sm:space-8 space-y-5.5 md:grid md:grid-cols-2 md:gap-3 md:space-y-0 lg:gap-6">
          ...
          <div className="space-y-2.5 lg:py-2">
            <p className="lg:text-4 font-raleway inline-block border-b-3 border-b-white pb-[4px] text-2lg font-bold lg:text-4sm">О нас</p>
          ...
          {/* ITEM */}
          <div className="space-y-2.5 lg:py-2">
            <p className="lg:text-4 font-raleway inline-block border-b-3 border-b-white pb-[4px] text-2lg font-bold lg:text-4sm">Где купить</p>
            <p className="text-left text-medium lg:text-2md">
